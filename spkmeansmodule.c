...
static PyMethodDef spkmeansMethods[] = {
    {"wam",  
        (PyCFunction) wam, 
      METH_VARARGS, 
      PyDoc_STR("gets data points and return its weighted adjacency matrix")},
    {"ddg",  
        (PyCFunction) ddg, 
      METH_VARARGS, 
      PyDoc_STR("gets data points and return its diagonal degree matrix")},
    {"gl",  
        (PyCFunction) gl, 
      METH_VARARGS, 
      PyDoc_STR("gets data points and return its graph laplacian")},
    {"jacobi",  
        (PyCFunction) jacobi, 
      METH_VARARGS, 
      PyDoc_STR("gets symetric matrix and performs jacobi algorithm on it")},
    {"spk",  
        (PyCFunction) spk, 
      METH_VARARGS, 
      PyDoc_STR("gets data points, K, and initial centroids and performs unormalized spectral clustering algorithm on it")},
